...
acc= "AC23407de05e9926834e7ea4a43978b9a8"
token = 'a48da8589aeca49747f77e52ea07b35b'
...
def MainController(app, request, db, render_template, redirect, session, smtpObj):
    ...
    # front end routes
    FrontEndController(app, request, db, render_template, session, redirect)
    ...
    def send_mail(email,subject,html):
        ...
        msg.attach(part2)
        smtpObj.sendmail("Your Email Id", email, msg.as_string()) 
        return
